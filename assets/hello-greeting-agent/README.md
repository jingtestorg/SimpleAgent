...
An AI agent that greets users with a personalised message based on the current time of day and live weather conditions, and can handle follow-up weather questions conversationally.
