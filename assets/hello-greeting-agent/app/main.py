...
def main(host: str, port: int):
    skill = AgentSkill(
        id="hello-greeting-agent",
        name="hello-greeting-agent",
        description="An AI agent that greets users with a personalised message based on the current time of day and live weather conditions, and can handle follow-up weather questions conversationally.",
        tags=["hello", "greeting", "weather", "agent"],
        examples=["Good morning! What's the weather like?", "What's the temperature in Berlin right now?"],
    )
